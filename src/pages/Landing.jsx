      ...
      <section style={{ padding: '100px 5vw', background: '#fff' }}>
        <div style={{ maxWidth: 800, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 32 }}>
            {[
              { num: '1', title: 'Daftar & bayar', desc: 'Buat akun, bayar Rp 99.000. Semua fitur langsung aktif selama 3 bulan.' },
        ...
        <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: window.innerWidth < 768 ? '1fr' : '1fr 1fr', gap: 16, marginBottom: 20 }}>
            <div style={{ background: '#00e676', borderRadius: 24, padding: '36px 28px', position: 'relative' }}>
              ...
              <div style={{ fontSize: 48, fontWeight: 800, color: '#0d2137', letterSpacing: -2, lineHeight: 1 }}>Rp 99.000</div>
