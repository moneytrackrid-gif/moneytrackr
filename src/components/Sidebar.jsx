        ...
        <div style={{ padding: '12px 10px 0', borderTop: '0.5px solid rgba(255,255,255,0.08)' }}>
          <div style={{ padding: '8px 10px', borderRadius: 'var(--radius-md)' }}>
            ...
            <button onClick={toggleTheme} style={{
              ...
              display: 'flex', position: 'relative', marginTop: 4,
            }}>
              <div style={{
              ...
              <div style={{ flex: 1, padding: '5px 0', fontSize: 10, fontWeight: 600, color: dark ? 'rgba(255,255,255,0.3)' : '#0d1b2a', position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4 }}>
                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>
                Light
              </div>
              <div style={{ flex: 1, padding: '5px 0', fontSize: 10, fontWeight: 600, color: dark ? '#0d1b2a' : 'rgba(255,255,255,0.3)', position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4 }}>
